...
fn main() {
    ...
    let update_node_data_to_3 = thread::spawn( move || {
        ...
        for i in 1..3 {
            println!("Updating to 3 (start query) {}", Utc::now());
            ...
            println!("Updating to 3 (end query) {}", Utc::now());
        }
    ...
    let update_node_data_to_5 = thread::spawn( move || {
        ...
        for i in 1..3 {
            println!("Updating to 5 (start query) {}", Utc::now());
            ...
            println!("Updating to 5 (end query) {}", Utc::now());
        }
    });
